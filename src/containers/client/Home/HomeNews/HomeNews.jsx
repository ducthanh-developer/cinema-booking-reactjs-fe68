            ...
            >
              <div className="row blog__top">
                <div className="col-sm-6 blog__item">
                  <div className="blog__image">
                    <a href="#">
                      <img src="./img/blog/lat-mat.png" alt />
                    </a>
                  </div>
                ...
                <div className="col-sm-6 blog__item">
                  <div className="blog__image">
                    <a href="#">
                      <img src="./img/blog/mortal-kombat.png" alt />
                    </a>
                  </div>
                  <div className="blog__text">
                    <h3>
                      <a href="#">
                        ...
                        ĐIỆN ẢNH NỔI TIẾNG ĐƯỢC CHUYỂN THỂ TỪ CÁC TỰA...
                      </a>
                    </h3>
                    <p>
              ...
              <div className="row blog__bot">
                <div className="col-12 col-sm-4 blog__item">
                  <div className="blog__image">
                    <a href="#">
                      <img src="./img/blog/promising-young-woman.png" alt />
                    </a>
                  </div>
                  <div className="blog__text">
                    <h3>
                ...
                <div className="col-12 col-sm-4 blog__item">
                  <div className="blog__image">
                    <a href="#">
                      <img src="./img/blog/vua-dep-lai-vua-tai-nang.png" alt />
                    </a>
                  </div>
                  <div className="blog__text">
                    <h3>
                  ...
                  <div className="row">
                    <div className="col-12 blog__item--miniPost">
                      <div className="blog__item--image">
                        <a href="#">
                          <img
                            src="./img/khai-truong-rap-xin-gia-ngon-chuan-xi-tai-sai-gon-16115477671555.jpg"
                            alt
                          />
                        </a>
                      </div>
                    ...
                    <div className="col-12 blog__item--miniPost">
                      <div className="blog__item--image">
                        <a href="#">
                          <img
                            src="./img/boc-tem-to-hop-giai-tri-moi-toanh-cua-gioi-ha-thanh-16056939435004.png"
                            alt
                          />
                        </a>
                      </div>
                    ...
                    <div className="col-12 blog__item--miniPost">
                      <div className="blog__item--image">
                        <a href="#">
                          <img
                            src="./img/tiec-trang-mau-chinh-thuc-can-moc-100-ty-chi-sau-2-tuan-cong-chieu-16043751284117.png"
                            alt
                          />
                        </a>
                      </div>
                    ...
                    <div className="col-12 blog__item--miniPost">
                      <div className="blog__item--image">
                        <a href="#">
                          <img
                            src="./img/ngo-thanh-van-chinh-thuc-khoi-dong-cuoc-thi-thiet-ke-trang-phuc-cho-sieu-anh-hung-dau-tien-cua-viet-nam-vinaman-16041584850247.jpg"
                            alt
                          />
                        </a>
                      </div>
              ...
              <div className="row blog__top">
                <div className="col-sm-6 blog__item">
                  <div className="blog__image">
                    <a href="#">
                      <img
                        src="./img/blog/review-tan-tich-quy-am-relic-ba-the-he-va-moi-lien-ket-15965255784224.png"
                        alt
                      />
                    </a>
                  </div>
                ...
                <div className="col-sm-6 blog__item">
                  <div className="blog__image">
                    <a href="#">
                      <img src="./img/blog/review-dinh-thu-oan.png" alt />
                    </a>
                  </div>
                  <div className="blog__text">
                    <h3>
              ...
              <div className="row blog__bot">
                <div className="col-12 col-sm-4 blog__item">
                  <div className="blog__image">
                    <a href="#">
                      <img
                        src="./img/blog/blackkklansman-coc-nuoc-lanh.png"
                        alt
                      />
                    </a>
                  </div>
                ...
                <div className="col-12 col-sm-4 blog__item">
                  <div className="blog__image">
                    <a href="#">
                      <img
                        src="./img/blog/american-sniper-chinh-nghia.png"
                        alt
                      />
                    </a>
                  </div>
                  ...
                  <div className="row">
                    <div className="col-12 blog__item--miniPost">
                      <div className="blog__item--image">
                        <a href="#">
                          <img
                            src="./img/blog/review-spider-man-into-the-spider-vesre-15886520889426.png"
                            alt
                          />
                        </a>
                      </div>
              ...
              <div className="row blog__top">
                <div className="col-sm-6 blog__item">
                  <div className="blog__image">
                    <a href="#">
                      <img
                        src="./img/blog/bhd-59k-ve-ca-tuan-16190002421777.jpg"
                        alt
                      />
                    </a>
                  </div>
                ...
                <div className="col-sm-6 blog__item">
                  <div className="blog__image">
                    <a href="#">
                      <img
                        src="./img/blog/tix-1k-ve-ngai-chi-gia-ve-16045662877511.jpg"
                        alt
                      />
                    </a>
                  </div>
              ...
              <div className="row blog__bot">
                <div className="col-12 col-sm-4 blog__item">
                  <div className="blog__image">
                    <a href="#">
                      <img
                        src="./img/blog/dong-gia-1k-ve-khi-mua-ve-qua-tix-16010092946804.png"
                        alt
                      />
                    </a>
                  </div>
                ...
                <div className="col-12 col-sm-4 blog__item">
                  <div className="blog__image">
                    <a href="#">
                      <img
                        src="./img/blog/bhd-star-ve-chi-59-000d-ca-tuan-15937622264546.jpg"
                        alt
                      />
                    </a>
                  </div>
